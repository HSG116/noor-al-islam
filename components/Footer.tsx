...
import { Download, MessageCircle, Send, Heart, ExternalLink, Shield, Scale } from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto flex flex-col items-center">
                ...
                >
                    <div className="relative mb-4 inline-block">
                        ...
                        <img src="./logo.webp" alt="Noor Al Islam" className="w-16 h-16 relative z-10 mx-auto" />
                    </div>
                ...
                {onNavigate && (
                    <div className="flex flex-wrap justify-center gap-3 mb-8">
                        <button onClick={() => onNavigate(ViewState.LEGAL)} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 transition-all text-xs font-bold">
                            <Scale size={14} />
                            جميع الصفحات القانونية
                        </button>
                    </div>
                )}
