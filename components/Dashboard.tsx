            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-emerald-500/60 text-xs md:text-lg font-black uppercase">تقدمك في حفظ كتاب الله</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <span className="text-xs md:text-sm font-black uppercase">مستوى المتقن</span>
                </motion.div>
            </motion.header>
                ...
                >
                    ...
                    <div className="relative z-10 space-y-8 md:space-y-12">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 px-5 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] md:text-xs font-black uppercase shadow-lg">
                                <Target size={14} />
                        ...
                        <div>
                            ...
                            <div className="flex justify-between mt-4 md:mt-6 text-[10px] md:text-lg font-black text-emerald-500/60 uppercase">
...
const StatCard = ({ icon, label, value, color, isWideOnMobile = false, delay = 0 }: { icon: any, label: string, value: number, color: string, isWideOnMobile?: boolean, delay?: number }) => {
    ...
    return (
        ...
        >
            ...
            <p className="text-slate-500 text-[10px] md:text-lg font-black uppercase mb-2">{label}</p>
